...
PowerPointでスライド内の禁止語を検出したところ。ルールごとにグルーピングされ、まとめて修正も1件だけの修正もできる:

![チェック画面（PowerPoint）](docs/screenshots/check-view.png)

タスクペイン単体（辞書タブ）。禁止語・正しい語・メモを登録し、JSONでインポート/エクスポートできる:

<img src="docs/screenshots/dictionary-view.png" alt="辞書編集画面" width="360">
